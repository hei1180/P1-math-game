...
import { WORLDS, RODS, LEVEL_COUNT, levelKey, isWorldOpen, isLevelOpen, isRushOpen } from '../../bonds-logic.js?v=202609251524';
...
let rodModule = null;
const loadRod = () => (rodModule = rodModule || import('../ui/Rod.js?v=202609251524').catch(() => null));
